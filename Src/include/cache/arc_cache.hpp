...
private:
    ...
    void adapt_first_ghost()
    {
        ...
        double ratio_between_ghosts_size = static_cast<double>(list_frequent_ghost_.size()) / list_first_ghost_.size();
    ...
    void adapt_second_ghost() 
    {
        ...
        const double ratio_between_ghosts_size = static_cast<double>(list_first_ghost_.size()) / list_frequent_ghost_.size();
